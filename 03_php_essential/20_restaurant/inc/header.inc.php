...
<!--    <title>Culinary Cove--><?php //if (!empty($pageTitle)): ?><!-- &bull; --><?php //echo $pageTitle; endif; ?><!--</title>-->
...
/*        if (empty($headerImg)) {
    ...
    */?>
  <header class="header-with-background" style="background-image: url('<?php if (!empty($headerImg)) echo $headerImg; else echo "images/pexels-engin-akyurt-1435904.jpg"?>'); ">
    <h1>Culinary Cove</h1>
